      ...
      <div className="about-wrap">
			<section className="section nth01">
				<div className="inner">
					...
					<div className="title-wrap">
						<p className="tit01" data-aos="fade-up" data-aos-duration="1000">아름다운 디지털 환경을<br className="hide-pc"/> 만들어 갑니다.</p>
						<p className="tit02 hide-mobile" data-aos="fade-up" data-aos-duration="1000">디앤디모바일은 날마다 디지털 세계에 아름다움을 더해 갑니다.
						</p>
						<p className="desc" data-aos="fade-up" data-aos-duration="1000">
							디앤디모바일은 현재 속에 안주하는 것이 아닌 현재를 넘어 아름다운 내일을 바라봅니다. <br className="hide-mobile"/>
							디지털의 발전에만 전념하는 것이 아니라 발전을 넘어 디지털 세계를 향유할 수 있는 사용자의 경험과 <br className="hide-mobile"/>
			...
			<section className="section nth02">
				<div className="inner">
					...
					<div className="title-wrap white">
						<p className="tit01" data-aos="fade-up" data-aos-duration="1000">UX.UI.DX</p>
						<p className="tit02 hide-mobile" data-aos="fade-up" data-aos-duration="1000">디앤디모바일은 UX.UI를 통한 디지털트랜스포메이션을 이루어
							갑니다.</p>
						<p className="desc" data-aos="fade-up" data-aos-duration="1000">
							디지털의 발전은 이제 사용하는 기술을 넘어 업무 전반에 거쳐 영향력을 더해 가고 있습니다.<br className="hide-mobile"/>
							디앤디모바일은 이에 발마춰 UX.UI를 통해 모든 산업에 적용 가능한 광범위한 비즈니스 전략, 디지털 포메이션을 이루어 갑니다.
						</p>
					</div>
					...
					<div className="service-list-wrap">
						...
						<div className="service-list" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
							<p className="tit01">Web<span>&</span>Mobile</p>
						...
						<div className="service-list" data-aos="fade-up" data-aos-delay="900" data-aos-duration="1000">
			...
			<section className="section nth03">
				<div className="inner">
					...
					<div className="title-wrap">
						<p className="tit01" data-aos="fade-up" data-aos-duration="1000">단순하게, 명쾌하게, 더 가치있게</p>
						<p className="tit02 hide-mobile" data-aos="fade-up" data-aos-duration="1000">선입견 없는 접근, 사용자의 이해를 통해 균형과 조화를
							이루어냅니다.</p>
						<p className="desc" data-aos="fade-up" data-aos-duration="1000">
							트렌드에 맞는 디자인 서비스를 제공하고, 클라이언트의 아이덴티티를 사용자에게 가장 흥미롭고 적합한 방법으로 전달 할 수 있는 방법을 제시하고 실행합니다.
						</p>
					</div>
			...
			<section className="section nth04">
				<div className="inner">
					...
					<div className="title-wrap">
						<p className="tit01" data-aos="fade-up" data-aos-duration="1000">고객과의 시선과 호흡을 <br className="hide-pc"/>맞추다</p>
						<p className="tit02 hide-mobile" data-aos="fade-up" data-aos-duration="1000">고객과의 시선과 호흡을 맞춰 성공적인 프로젝트를 수행하겠습니다.
						</p>
						<p className="desc" data-aos="fade-up" data-aos-duration="1000">
							디앤디모바일은 각 분야의 전문성을 가진 ManPower, 역할과 규칙을 공유하는 체계적인 시스템을 유지하며 스스로의 가치와 의미로 긍정적 경험을 제공합니다.
						</p>
					</div>
